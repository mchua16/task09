...
The take_mean package allows users to take the mean of any vector by simply applying the mean() function, which is built into the R Base Package.

## take_mean Requirements

1) To use the take_mean function, vectors must be numeric. 
